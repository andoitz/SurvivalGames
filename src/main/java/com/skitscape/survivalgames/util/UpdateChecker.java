...
/* 71 */         player.sendMessage(ChatColor.DARK_BLUE.toString() + "--------------------------------------");
/* 72 */         player.sendMessage(ChatColor.DARK_RED.toString() + "[SurvivalGames] Updated Avaliable!");
/* 73 */         player.sendMessage(ChatColor.DARK_AQUA.toString() + "Your version: " + ChatColor.GOLD + v + ChatColor.DARK_AQUA + " Latest: " + ChatColor.GOLD + in[1]);
/* 74 */         player.sendMessage(ChatColor.DARK_AQUA.toString() + in[2]);
/* 75 */         player.sendMessage(ChatColor.AQUA.toString()+ChatColor.UNDERLINE.toString() + in[3]);

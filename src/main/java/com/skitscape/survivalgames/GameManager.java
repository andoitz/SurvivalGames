...
/*  25 */   private ArrayList<Game> games = new ArrayList<Game>();
   private SurvivalGames p;
/*  27 */   public static HashMap<Integer, HashSet<Block>> openedChest = new HashMap<Integer, HashSet<Block>>();
/*  29 */   private HashMap<Player, Integer> PGRC = new HashMap<Player, Integer>();
...
/*  43 */       openedChest.put(Integer.valueOf(g.getID()), new HashSet<Block>());
   }
...
/* 204 */     ArrayList<Game> qg = new ArrayList<Game>(5);
...
/* 288 */     openedChest.put(Integer.valueOf(id), new HashSet<Block>());
   }

 ...
 public class LoggingManager
   implements Listener
 {
/*  32 */   public static HashMap<String, Integer> i = new HashMap<String, Integer>();
...
/* 176 */       return;
/* 177 */     if (GameManager.getInstance().getGameMode(GameManager.getInstance().getBlockGameId(b.getLocation())) == GameMode.DISABLED)
/* 178 */       return;
...
/* 195 */       return;
/* 196 */     if (GameManager.getInstance().getGameMode(GameManager.getInstance().getBlockGameId(b.getLocation())) == GameMode.DISABLED)
/* 197 */       return;

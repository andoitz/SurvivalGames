...
/*  46 */     this.commands = new HashMap<String, SubCommand>();
/*  47 */     loadCommands();
   }
...
/* 100 */         player.sendMessage(ChatColor.GOLD + ChatColor.BOLD.toString() + "Survival Games - Double0negative" + ChatColor.RESET.toString() + ChatColor.YELLOW.toString() + " Version: " + pdfFile.getVersion());
...
/* 111 */       Vector<String> l = new Vector<String>();

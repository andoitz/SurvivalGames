...
/* 105 */   private final Set<Graph> graphs = Collections.synchronizedSet(new HashSet<Graph>());
 
/* 110 */   private final Graph defaultGraph = new Graph("Default");
...
/* 175 */     Graph graph = new Graph(name);
...
/* 247 */                 for (final Metrics.Graph graph : Metrics.this.graphs) {
/* 248 */                   graph.onOptOut();
                 }
...
/* 375 */       Iterator<Graph> iter = this.graphs.iterator();
       Iterator<?> localIterator1;
/* 377 */       for (; iter.hasNext(); 
/* 380 */         localIterator1.hasNext())
       {
/* 378 */         Graph graph = iter.next();
 
/* 380 */         localIterator1 = graph.getPlotters().iterator(); continue;       }
...
/* 431 */         Iterator<Graph> iter = this.graphs.iterator();
         Iterator<?> localIterator2;
/* 433 */         for (; iter.hasNext(); 
/* 436 */           localIterator2.hasNext())
         {
/* 434 */           Graph graph = iter.next();
 
/* 436 */           localIterator2 = graph.getPlotters().iterator(); continue;         }
       }
   }
...
/* 501 */     private final Set<Metrics.Plotter> plotters = new LinkedHashSet<Plotter>();
